...
from .loaders import ConfigLoader, TxtLoader, ConfigError
...
class Config:
    ...
    @property
    def width(self) -> int: return int(self._data["WIDTH"])

    @property
    def height(self) -> int: return int(self._data["HEIGHT"])
    ...
    @property
    def output_file(self) -> str: return self._data["OUTPUT_FILE"]

    @property
    def perfect(self) -> bool: return self._data["PERFECT"]

    @property
    def seed(self) -> int | None: return self._data.get("SEED")
