from generator import DfsGenerator, TxtWriter, GenerationError
import pytest
...
def test_maze_dimensions():
    ...
    cfg = MockConfig()
    gen = DfsGenerator(cfg, TxtWriter())
...
def test_seed_reproducibility():
    ...
    cfg = MockConfig()
    gen1 = DfsGenerator(cfg, TxtWriter())
    gen2 = DfsGenerator(cfg, TxtWriter())
    gen1.generate()
    gen2.generate()
